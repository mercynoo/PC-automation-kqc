    ...
    def test_pay1(self):
        ...
        for handle in all_handles:
            if handle != now_handle:
                ...
                sleep(1)
                driver.find_element_by_xpath(".//*[@id='J_tLoginId']").send_keys("13071832065")
                sleep(1)
                driver.find_element_by_xpath(".//*[@id='payPasswd_rsainput']").clear()
                sleep(1)
                driver.find_element_by_xpath(".//*[@id='payPasswd_rsainput']").send_keys("118412")
                driver.find_element_by_id("payPasswd_rsainput").send_keys(Keys.RETURN)
                sleep(10)
                driver.find_element_by_css_selector(".sixDigitPassword").send_keys("118412")
                sleep(1)
