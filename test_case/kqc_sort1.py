...
class Sort(unittest.TestCase):
    ...
    def test_sort1(self):
        ...
        driver.find_element_by_xpath(".//*[@id='hot-model']/div[1]/a").click()
        ...
        for handle in all_handles:
            if handle != now_handle:
                ...
                sleep(1)    
                price2 = driver.find_element_by_xpath("html/body/div[2]/div[4]/ul/li[10]/div[2]/div/span[1]/b").text
                ...
                price4 = driver.find_element_by_xpath("html/body/div[2]/div[4]/ul/li[6]/div[2]/div/span[1]/b[1]").text
                ...
                win32api.keybd_event(35,0,0,0)
                sleep(1)
                discount2 = driver.find_element_by_xpath("html/body/div[2]/div[4]/ul/li[6]/div[2]/div/span[3]").text
                ...
                c = re.findall(r"[0-9]+.+[0-9]+",discount3)
                c1 = c[0]
                win32api.keybd_event(35,0,0,0)
                sleep(1)
                discount4 = driver.find_element_by_xpath("html/body/div[2]/div[4]/ul/li[10]/div[2]/div/span[3]").text
